...
$_SESSION["updateid"] = $update_id;

if(empty($_GET["editid"])){
    header("Location: login.php");
}

$sql = "SELECT * FROM creatadd WHERE addid ='$update_id'";
...
<div class="container">
      <h2>Update file to olx</h2>
      <P>Update some title and descriptions</p>
  <form action="editcon.php" method="post" enctype="multipart/form-data">
    <div class="form-group">
        <label for="usr">Title:</label>
        <input type="text" class="form-control" id="usr"name="title" value ="<?php echo $row["title_name"]; ?>">
    </div>
    <div class="form-group">
      <label for="comment">Descriptions:</label>
      <textarea class="form-control" rows="5" id="comment" name="description" value ="<?php echo $row["description_name"];?>"></textarea>
    </div>
    <div class="form-group">
